...
namespace Todo.Models 
{
    public partial class MyEntityContext : BrightstarEntityContext {
        ...
        public static void InitializeEntityMappingStore()
        {
    		...
    		provider.AddMappingsForType(EntityMappingStore.Instance, typeof(Todo.ITodoItem));
    		EntityMappingStore.Instance.SetImplMapping<Todo.ITodoItem, Todo.TodoItem>();
    	}
    	...
    	{
    		TodoItems = 	new BrightstarEntitySet<Todo.ITodoItem>(this);
    	}
    	
    	public IEntitySet<Todo.ITodoItem> TodoItems
    	{
    		get; private set;
    	}
        ...
        public IEntitySet<T> EntitySet<T>() where T : class {
            ...
            if (typeof(T).Equals(typeof(Todo.ITodoItem))) {
                return (IEntitySet<T>)this.TodoItems;
            }
...
namespace Todo 
{
    ...
    public partial class TodoItem : BrightstarEntityObject, ITodoItem 
    {
    	public TodoItem(BrightstarEntityContext context, BrightstarDB.Client.IDataObject dataObject) : base(context, dataObject) { }
        public TodoItem(BrightstarEntityContext context) : base(context, typeof(TodoItem)) { }
    	public TodoItem() : base() { }
    	public System.String ID { get {return GetKey(); } set { SetKey(value); } }
    	#region Implementation of Todo.ITodoItem
    	...
    	{
            		get { return GetRelatedProperty<System.Boolean>("Done"); }
            		set { SetRelatedProperty("Done", value); }
    	}
    	#endregion
    }
}
